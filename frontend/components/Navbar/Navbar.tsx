...
const navigation = [
  { name: 'Home', href: '/aps' },
  { name: 'Avaliação Inicial', href: '/aps/evaluation' },
  { name: 'Prontuários', href: '/aps/patient' },
  { name: 'Agenda', href: '/aps/schedule' },
]
const userNavigation = [
  { name: 'Perfil', href: '/aps/profile' },
  { name: 'Configurações', href: '/aps/settings' },
